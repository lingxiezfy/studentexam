           ...
           <div class="tile-body">
             <form class="form-horizontal" id="myform">
               <div class="form-group row">
                 <label class="control-label col-md-3" for="name"><span style="color:red;">*</span>年级</label>
                 <div class="col-md-8">
                   <input class="form-control" type="text" id="name" name="name" placeholder="请输入年级">
                   <div id="error"></div>
                 </div>
      ...
      $("#myform").validate({
          ...
          submitHandler:function(){
        	  $.ajax({
        		  ...
        		  type:'post',
        		  url:'${basePath}adminManager/saveGrade',
