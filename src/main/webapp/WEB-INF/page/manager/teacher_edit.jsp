           ...
           <div class="tile-body">
             <form class="form-horizontal" id="myform">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-md-8">
                   <input class="form-control" type="text" id="username" name="username" value="${teacher.username }" placeholder="请输入用户名">
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-md-3" for="realname"><span style="color:red;">*</span>姓名</label>
                 <div class="col-md-8">
                   <input class="form-control" type="text" id="realname" name="realname" value="${teacher.realname }" placeholder="请输入姓名">
                 </div>
               </div>
             </form>
           </div>
