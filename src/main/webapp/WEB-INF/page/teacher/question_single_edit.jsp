           ...
           <div class="tile-body">
             <form class="form-horizontal" id="myform">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-md-8">
                   <textarea class="form-control" id="title" name="title" rows="3">${single.title }</textarea>
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-md-3" for="optiona"><span style="color:red;">*</span>A</label>
                 <div class="col-md-8">
                   <input class="form-control" type="text" id="optiona" name="optiona" value="${single.optiona }">
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-md-3" for="optionb"><span style="color:red;">*</span>B</label>
                 <div class="col-md-8">
                   <input class="form-control" type="text" id="optionb" name="optionb" value="${single.optionb }">
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-md-3" for="optionc"><span style="color:red;">*</span>C</label>
                 <div class="col-md-8">
                   <input class="form-control" type="text" id="optionc" name="optionc" value="${single.optionc }">
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-md-3" for="optiond"><span style="color:red;">*</span>D</label>
                 <div class="col-md-8">
                   <input class="form-control" type="text" id="optiond" name="optiond" value="${single.optiond }">
                 </div>
               </div>
               <div class="form-group row">
                 ...
                 <div class="col-md-8">
                   <div class="animated-radio-button">
		              <label>
		                <input type="radio" name="answer" value="A" <c:if test="${single.answer eq 'A' }">checked</c:if>><span class="label-text">A</span>
		              </label>
		              &nbsp;&nbsp;&nbsp;&nbsp;
		              <label>
		                <input type="radio" name="answer" value="B" <c:if test="${single.answer eq 'B' }">checked</c:if>><span class="label-text">B</span>
		              </label>
		              &nbsp;&nbsp;&nbsp;&nbsp;
		              <label>
		                <input type="radio" name="answer" value="C" <c:if test="${single.answer eq 'C' }">checked</c:if>><span class="label-text">C</span>
		              </label>
		              &nbsp;&nbsp;&nbsp;&nbsp;
		              <label>
		                <input type="radio" name="answer" value="D" <c:if test="${single.answer eq 'D' }">checked</c:if>><span class="label-text">D</span>
		              </label>
		            </div>
                 </div>
               </div>
               <div class="form-group row">
                 ...
                 <div class="col-md-8">
                   <input class="form-control" type="number" id="score" name="score" value="${single.score }">
                 </div>
               </div>
             </form>
           </div>
      ...
      $("#myform").validate({
          ...
          submitHandler:function(){
        	  $.ajax({
        		  ...
        		  type:'post',
        		  url:'${basePath}teacher/updateSingle',
