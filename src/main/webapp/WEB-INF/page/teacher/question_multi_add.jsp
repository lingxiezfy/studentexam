                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="animated-radio-button">
                                    <label>
                                        <input type="checkbox" name="answer" value="A"><span class="label-text">A</span>
                                    </label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                        <input type="checkbox" name="answer" value="B"><span class="label-text">B</span>
                                    </label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                        <input type="checkbox" name="answer" value="C"><span class="label-text">C</span>
                                    </label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                        <input type="checkbox" name="answer" value="D"><span class="label-text">D</span>
                                    </label>
                                </div>
                            </div>
                        </div>
        ...
        $("#myform").validate({
            ...
            submitHandler:function(){
                $.ajax({
                    ...
                    type:'post',
                    url:'${basePath}teacher/saveMulti',
