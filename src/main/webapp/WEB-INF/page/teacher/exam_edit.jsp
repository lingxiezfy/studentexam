           ...
           <div class="tile-body">
             <form class="form-horizontal" id="myform">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-md-8">
                   <input class="form-control" type="text" id="title" name="title" value="${exam.title }" placeholder="请输入试卷名称">
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-md-3" for="timeLimit"><span style="color:red;">*</span>时长（分钟）</label>
                 <div class="col-md-8">
                   <input class="form-control" type="number" id="timeLimit" name="timeLimit" value="${exam.timeLimit }" placeholder="请输入考试时长">
                 </div>
               </div>
             </form>
           </div>
      ...
      $("#myform").validate({
          ...
          submitHandler:function(){
        	  $.ajax({
        		  ...
        		  type:'post',
        		  url:'${basePath}teacher/updatePaper',
