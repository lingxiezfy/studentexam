            ...
            <div class="tile" style="padding-bottom: 8px">
                <div class="tile-body">
                    <form class="form-horizontal" id="myform">
                        <input type="hidden" value="${judge.id }" name="id">
                        <div class="form-group row">
                            <label class="control-label col-md-3" for="title"><span style="color:red;">*</span>题目</label>
                            <div class="col-md-8">
                                <textarea class="form-control" id="title" name="title" rows="3">${judge.title }</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="animated-radio-button">
                                    <label>
                                        <input type="radio" name="answer" value="0" <c:if test="${judge.answer eq '0' }">checked</c:if>><span class="label-text">正确</span>
                                    </label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                        <input type="radio" name="answer" value="1" <c:if test="${judge.answer eq '1' }">checked</c:if>><span class="label-text">错误</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="number" id="score" name="score" value="${judge.score }">
                            </div>
                        </div>
                    </form>
                </div>
        ...
        $("#myform").validate({
            ...
            submitHandler:function(){
                $.ajax({
                    ...
                    type:'post',
                    url:'${basePath}teacher/updateJudge',
