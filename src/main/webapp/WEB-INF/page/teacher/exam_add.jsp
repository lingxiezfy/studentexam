                ...
                <div class="tile-body">
                    <form class="form-horizontal" id="myform">
                        <div class="form-group row">
                            <label class="control-label col-md-3" for="title"><span
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="number" id="timeLimit" name="timeLimit"
                                       placeholder="请输入考试时长">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div id="autoGenerateOption">
                            <div class="form-group row">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input class="form-control" type="number" id="singleCount" name="singleCount" placeholder="单选题数量" value="0">
                                &nbsp;&nbsp;&nbsp;
                                <input class="form-control" type="number" id="multiCount" name="multiCount" placeholder="多选题数量" value="0">
                                &nbsp;&nbsp;&nbsp;
                                <input class="form-control" type="number" id="judgeCount" name="judgeCount" placeholder="判断题数量" value="0">
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $(function () {
        $("#autoGenerateOption").hide();
        $('#singleCount').css('width','30%');
        $('#multiCount').css('width','30%');
        $('#judgeCount').css('width','30%');
        $("#myform").validate({
            //验证规则
            rules: {
                title: {
